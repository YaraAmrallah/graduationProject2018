...
static const float g_fMPU6050AccelFactors[] = { 0.00059875, // Range = +/- 2 g (16384 lsb/g)
        0.00119751,                              // Range = +/- 4 g (8192 lsb/g)
        0.00239502,                              // Range = +/- 8 g (4096 lsb/g)
        0.00479004                             // Range = +/- 16 g (2048 lsb/g)
        };
static const float g_fMPU6050GyroFactors[] = { 1.3323124e-4f, // Range = +/- 250 dps  (131.0 LSBs/DPS)
