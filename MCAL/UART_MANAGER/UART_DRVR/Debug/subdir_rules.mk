...
GPIO.obj: ../GPIO.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="D:/Engineering/engineering (BIBO)/4th year/graduation project/UART+GPS/UART_DRVR" --include_path="E:/Engineering/engineering (BIBO)/4th year/graduation project/UART+GPS/GPIO_DRVR" --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include" --define=ccs="ccs" --define=PART_TM4C123GH6PM -g --gcc --diag_warning=225 --diag_wrap=off --display_error_number --abi=eabi --preproc_with_compile --preproc_dependency="GPIO.d_raw" $(GEN_OPTS__FLAG) "$<"
