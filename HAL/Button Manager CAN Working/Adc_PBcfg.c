...
Adc_HwUnitConfigType Adc_HwUnitConfig[NUMBER_OF_HW_UNITS]=
{
    ...
    },
    {
     ...
     1,
     1  /* Pointer to the Adc_ChannelGroup*/
    },
    {
     ...
     /* maximum for this hw unit is 4 */
     1,
     2  /* Pointer to the Adc_ChannelGroup*/
    },
    {
    ...
    },
    {
     ...
     /* maximum for this hw unit is 8 */
     1,
     4    /* Pointer to the Adc_ChannelGroup*/
    },
    {
...
const Adc_ConfigType Adc_Config=
{
    ...
    ADC_1_M_SAMPLING_SPEED,   /* 500 kilo sample per second. */
    TRUE, /* True: Configure and enable clock for module 1, False: Don't configure */
    ADC_1_M_SAMPLING_SPEED,
    &Adc_HwUnitConfig[0]
};
